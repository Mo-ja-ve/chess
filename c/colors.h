...
const string T_BLACK      = "\e[30m";
const string T_RED        = "\e[31m";
const string T_GREEN      = "\e[32m";
const string T_YELLOW     = "\e[33m";
const string T_BLUE       = "\e[34m";
const string T_MAGENTA    = "\e[35m";
const string T_CYAN       = "\e[36m";
const string T_WHITE      = "\e[37m";
